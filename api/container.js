...
container
  ...
  .register({
    ...
    OptionController: asClass(OptionController).singleton()
  })
  .register({
  ...
  .register({
    ...
    OptionRoutes: asFunction(OptionRoutes).singleton()
  })
  .register({
    ...
    OptionService: asClass(OptionService).singleton()
  })
  .register({
  ...
  .register({
    ...
    OptionBusiness: asClass(OptionBusiness).singleton()
  })
  ;
